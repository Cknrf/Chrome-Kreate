 ...
 */
public class CustomBorderPostStack extends JPanel {

    public CustomBorderPostStack() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(275, 16)); // Set a fixed height
