...
public class ScrollBarWin11UI extends BasicScrollBarUI {
    ...
    private final Color thumbColor = new Color(0, 0, 0);
    private final Color scrollPane = new Color(0, 166, 138);
    ...
    public void installUI(JComponent c) {
        ...
        c.setForeground(thumbColor);
        initAnimator();
        if (c instanceof JScrollBar) {
            JScrollBar scrollBar = (JScrollBar) c;
            scrollBar.setUnitIncrement(15); // Set unit increment
            scrollBar.setBlockIncrement(15); // Set block increment
        }
    }
    ...
    private class ScrollButton extends JButton {
        ...
        public ScrollButton(int orientation, boolean isIncrease) {
            ...
            arrow = new PolygonClass().getRoundedGeneralPathFromPoints(points, scrollSize * 0.5f);
