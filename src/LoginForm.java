...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(164, 143, 160));
        ...
        jLabel3.setForeground(new java.awt.Color(164, 143, 160));
    ...
    private void login() {
        try {
            ...
            pst = con.prepareStatement("SELECT * FROM account_table WHERE username = ? AND password = ?");
            pst.setString(1, username);
            pst.setString(2, password);
            rs = pst.executeQuery();

            if (rs.next() == true) {
                new FacebookInterface(username).setVisible(true);
                this.setVisible(false);
            } else {
